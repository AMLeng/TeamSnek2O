...
DATA_DIR = "data/TimeStampedOriginal/centerImages/"  # NOTE: Change this accordingly to match whether the data is for
# training or testing. Should probably modify to use python flags
LOG_FILE = "data/TimeStampedOriginal/approximatedStamps.txt"
GLOBALHEIGHT = 480
GLOBALWIDTH = 640
