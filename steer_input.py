...
DATA_DIR_LIST = ["TimeStampedOriginal/centerImages/"]  # NOTE: Change this accordingly to match whether the data is for
# training or testing. Should probably modify to use python flags
LOG_FILE_LIST = ["TimeStampedOriginal/approximatedStamps.txt"]
GLOBALHEIGHT = 480
GLOBALWIDTH = 640
